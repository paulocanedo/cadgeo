 ...
 * @author paulocanedo
 */
public class CalculationAreaCommand extends AbstractCadCommand {

    public CalculationAreaCommand(GLTopographicPanel displayPanel, String message) {
        super(displayPanel, "");
    }

    public CalculationAreaCommand() {
        super("");
    }
    ...
    @Override
    public void execute() {
        UserInterfaceUtil.showDialog(UserInterfaceUtil.CALCULATION_AREA, getDisplayPanel().getPolygonal());
    ...
    public CadCommand newInstance(GLTopographicPanel displayPanel) throws CommandException {
        return new CalculationAreaCommand(displayPanel, "");
    }
