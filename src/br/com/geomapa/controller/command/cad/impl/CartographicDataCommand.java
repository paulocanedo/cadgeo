 ...
 * @author paulocanedo
 */
public class CartographicDataCommand extends AbstractCadCommand {

    public CartographicDataCommand(GLTopographicPanel displayPanel, String message) {
        super(displayPanel, "");
    }

    public CartographicDataCommand() {
        super("");
    }
    ...
    @Override
    public void execute() {
        UserInterfaceUtil.showDialog(UserInterfaceUtil.CARTOGRAFIC_DATA, getDisplayPanel().getPolygonal());
    ...
    public CadCommand newInstance(GLTopographicPanel displayPanel) throws CommandException {
        return new CartographicDataCommand(displayPanel, "");
    }

    @Override
    public String toString() {
        return "Dados Cartográficos";
    }

    @Override
    public String getCommandName() {
        return "dados_cartograficos";
    }
}
