 ...
 * @author paulocanedo
 */
public class MemorialCommand extends AbstractCadCommand {

    public MemorialCommand(GLTopographicPanel displayPanel, String message) {
        super(displayPanel, "");
    }

    public MemorialCommand() {
        super("");
    }
    ...
    @Override
    public void execute() {
        UserInterfaceUtil.showDialog(UserInterfaceUtil.MEMORIAL, getDisplayPanel().getPolygonal());
    ...
    public CadCommand newInstance(GLTopographicPanel displayPanel) throws CommandException {
        return new MemorialCommand(displayPanel, "");
    }
